...
#     return response.text
#
# def HTML_Transform(cleaned_content):
#     response = client.models.generate_content(
#         model="gemini-2.5-flash",
...
#     )
#     print("The HTML Code was generated.")
#     return response.text
#
# def HTML_Validator(code):
#     response = client.models.generate_content(
#         model="gemini-2.5-flash",
...
# HTML CODE = {html_code}"""
#     )
#     print("The Code Was Styled.")
#     return response.text
#
# def Final_Cleaner(data):
#     response = client.models.generate_content(
#         model="gemini-2.5-flash",
#         contents=f"""Your task is to return just the HTML code present in the data as the output only. Also improve if there is any  mistake. Return JUST the HTML code.Start directly with <!DOCTYPE html>...
# The Data = {data}"""
#     )
#     return response.text
#
# function = [Content_Agent, HTML_Transform, HTML_Validator, UI_Agent, UI_Agent, Final_Cleaner]
#
...
#
# def WorkFlow(name):
#     final_code = Pipeline(name, function)
#     # Avoid brittle string replacements; rely on Final_Cleaner to ensure clean HTML
#     return final_code
#
# # Routes
# @app.route('/')
